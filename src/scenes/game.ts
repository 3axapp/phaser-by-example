...
import {SceneEffect} from "../game-objects/scene-effect";
import {PowerUp} from "../game-objects/power-up";
import {FoeGenerator} from "../game-objects/foe-generator";
import {Shot} from "../game-objects/shot";
import {FoeShot} from "../game-objects/foe-shot";
import {Foe} from "../game-objects/foe";
import {TShootinMethodTypes} from "../game-objects/shooting-patterns";
...
export class Game extends Phaser.Scene
{
    ...
    private scores: Record<string, { scoreText: Phaser.GameObjects.BitmapText }>;
    public trailLayer: Phaser.GameObjects.Layer;
    private shake: PowerUp;
    private available: TShootinMethodTypes[];
    ...
    private shotsLayer: Phaser.GameObjects.Layer;
    public shots: Phaser.GameObjects.Group;
    private lastDestroyedWaveFoe: { x: any; y: any };
    private audios: any;
    ...
    create()
    {
        this.duration      = (this.time as any) * 1000;
    ...
    addPlayers()
    {
        ...
        this.players.add(this.player as any);
    }
    ...
    endScene()
    {
        this.foeWaveGroup.children.entries.forEach(((foe: Foe) => foe.shadow.destroy()) as any);
        this.foeGroup.children.entries.forEach(((foe: Foe) => foe.shadow.destroy()) as any);
        this.shots.children.entries.forEach(((shot: Shot) => shot.shadow.destroy()) as any);
        this.foeShots.children.entries.forEach(((shot: Shot) => shot.shadow.destroy()) as any);
    ...
    /*
      ...
      */
    updateScore(playerName: string | 'player1' | 'player2', points = 0)
    {
